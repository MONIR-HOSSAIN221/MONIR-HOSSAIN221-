...
|_____||_____|`.___.'|_____|\____||_____||____| |___|    7.1   """)
   
def space():
    print("\n")


number=int("+8801886019617")

devoloper_info={
    "Developer" :  'MONIR HOSSAIN',
    "Number" :  number,
    "Status" :  '24-ONLINE',
    "Facebook" :  'https://www.facebook.com/qwetuwqwrtyyyrewwqedddgtreertt?mibextid=ZbWKwL',
    }
...
note1="""- __Inbox__ Me for Join MONIR HOSSAIN\n- Try tool and **Review**"""
n1=Markdown(note1)
